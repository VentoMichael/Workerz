    ...
    <section class="bg-white">
        ...
        <div class="relative bg-gray-800">
            ...
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                <h1 class="text-4xl font-extrabold tracking-tight text-white md:text-5xl lg:text-6xl">Our Terms
                    Policy</h1>
                <p class="mt-6 max-w-3xl text-xl text-gray-300">The Workerz Terms of Service govern your use of our
            ...
            <div class="py-16">
                ...
                <section class="mb-12">
                    ...
                    <ul class="max-w-xl space-y-1 list-disc list-inside text-gray-600 mb-6">
                        ...
                        <li class="ml-4">
                            Reproduce, duplicate, copy or otherwise exploit material on our website for a commercial
                            purpose
                        </li>
                        <li class="ml-4">
