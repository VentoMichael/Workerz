...
@section('description', 'This Disclaimer page outlines the limitations of liability and disclaimers of warranties for Workerz website, https://www.workerz.be By using our website, you accept this disclaimer in full. If you disagree with any part of this disclaimer, do not use our website')
@section('keywords', 'Disclaimer, Limitations of Liability, Disclaimers of Warranties, workerz, https://www.workerz.be')
        ...
        <div class="relative bg-gray-800">
            ...
            <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
                ...
                <p class="mt-6 max-w-3xl text-xl text-gray-300">
                    The Workerz Disclaimer Policy outlines the limitations of liability and the use of information on our website, <a class="font-medium text-blue-400 underline hover:no-underline" href="https://www.workerz.be" target="_blank">workerz.be</a>. By accessing or using our website, you acknowledge and accept the terms and conditions of this disclaimer policy. If you have any questions or concerns about this policy, please do not hesitate to <a class="font-medium text-blue-400 underline hover:no-underline" href="mailto:workerz@support.be">contact us</a>.
                </p>
            </div>
        </div>
        ...
        <div class="py-16">
            ...
            <section>
                ...
                <p class="mb-3 text-gray-600 mb-8 mt-2">
                    If you require any more information or have any questions about our site's disclaimer, please feel free to contact us by email at <a class="font-medium text-blue-600 underline hover:no-underline" href="mailto:workerz@support.be">workerz@support.be</a>.
                </p>
                <p class="mb-3 text-gray-600 mb-8 mt-2">
                    All the information on this website - <a class="font-medium text-blue-600 underline hover:no-underline" href="https://www.workerz.be" target="_blank">workerz.be</a> - is published in good faith and for general information purpose only. Workerz does not make any warranties about the completeness, reliability, and accuracy of this information. Any action you take upon the information you find on this website (Workerz), is strictly at your own risk. Workerz will not be liable for any losses and/or damages in connection with the use of our website.
                </p>
                <p class="mb-3 text-gray-600 mb-8 mt-2">
