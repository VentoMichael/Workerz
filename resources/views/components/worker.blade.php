<section class="overflow-visible bg-white shadow overflow-hidden sm:rounded-md relative">
    <div class="top-5 absolute right-6 inline-block text-left">
        <div class="flex gap-1">
            <button type="button"
                    class="button-share-worker-1 inline-flex items-center justify-center w-full px-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            ...
            <button type="button"
                    class="button-signal-worker-1 inline-flex items-center justify-center w-full px-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    id="dropdown-menu-button" aria-expanded="true" aria-haspopup="true">
                <span class="text-2xl">...</span>
            </button>
        </div>
        <div
            class="content-share-worker-1 hidden origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
        ...
        <div
            class="content-signal-worker-1 hidden origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
            role="menu" aria-orientation="vertical"
            aria-labelledby="dropdown-menu-button" tabindex="-1">
            <div class="py-1" role="none">
                <div class="block px-4 py-2 hover:bg-gray-100 hover:text-gray-900">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex text-sm sm:items-end flex-col sm:flex-row">
                            ...
                            <p class="sm:ml-1 flex-shrink-0 text-md font-normal text-gray-500">&bull; Business
                                Development</p>
                        </div>
                    </div>
