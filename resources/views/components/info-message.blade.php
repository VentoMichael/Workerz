@if($message)
    <div class="z-50 max-w-xs flex gap-5 fixed right-8 bottom-4 bg-blue-100 border-t-4 border-blue-500 rounded-b text-teal-900 px-5 py-4 shadow-md" role="alert">
