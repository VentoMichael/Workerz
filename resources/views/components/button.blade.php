@props([
    ...
    'colors' => [
        ...
        'danger' => 'whitespace-nowrap inline-flex items-center justify-center text-white bg-red-700 hover:bg-red-800 bg-origin-border px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white',
    ]
])
