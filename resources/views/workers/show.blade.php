                                ...
                                <ul role="list" class="divide-y space-y-6">
                                    <li class="pt-6">
                                            ...
                                            <div class="space-y-1 font-medium">
                                                <p>Jese Leos
                                                    <time datetime="2014-08-16 19:00"
                                                          class="block text-sm text-gray-500">Joined on August 2014
                                                    </time>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="flex items-center mb-1">
                                            ...
                                            <span>Published on
                                                <time datetime="2017-03-03 19:00">03/03/17, 19h00</time>
                                            </span>
                                            </p>

                                        </div>
                                        <p class="mb-2 text-gray-500">This is my third Invicta Pro Diver. They are just
                                            fantastic value for money. This one arrived yesterday and the first thing I
                                            did was set the time, popped on an identical strap from another Invicta and
                                            went in the shower with it to test the waterproofing.... No problems.</p>
                                        <a href="#"
                                           class="block mb-5 text-sm font-medium text-blue-600 hover:underline">Read
                                            more</a>
                                        <div>
                                            ...
                                            <div class="flex items-center mt-3 space-x-3 divide-x divide-gray-200">
                                                <a href="#"
                                                   class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-xs px-2 py-1.5">Helpful</a>
                                            </div>
                                        </div>
                                    ...
                                    <li class="pt-6">
                                        ...
                                        <p class="mb-2 text-gray-500">This is my third Invicta Pro Diver. They are just
                                            ...
                                            did was set the time, popped on an identical strap from another Invicta and
                                            went in the shower with it to test the waterproofing.... No problems.</p>
                                        <p class="mb-3 text-gray-500">It is obviously not the same build quality as
                                            those very expensive watches. But that is like comparing a Citroën to a
                                        ...
                                        <div class="flex space-x-1 mb-2 items-center" id="star-rating">
                                            ...
                                            <fieldset class="flex space-x-1 mb-2 items-center">
                                                ...
                                                <label for="star3" class="star"
                                                       style="font-size: 1.5rem; cursor: pointer;">
                                                    <span class="sr-only">Three star</span>
                                                    <svg class="hover:text-yellow-300 w-4 h-4 text-gray-300 mr-1"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="currentColor" viewBox="0 0 22 20">
                                                        <path
                                                ...
                                                <label for="star4" class="star"
                                                       style="font-size: 1.5rem; cursor: pointer;">
                                                    <span class="sr-only">Fourth star</span>
                                                    <svg class="hover:text-yellow-300 w-4 h-4 text-gray-300 mr-1"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="currentColor" viewBox="0 0 22 20">
                                                        <path
                                ...
                                <div>
                                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                        ...
                                        <a href="#" aria-current="page"
                                           class="relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-700">1</a>
                                        <a href="#"
            ...
            starLabels.forEach((starLabel, index) => {
                ...
                starLabel.addEventListener('click', () => {
                    ...
                    for (let i = index + 1; i < starLabels.length; i++) {
                        starLabels[i].classList.remove('text-yellow-300');
                    }
