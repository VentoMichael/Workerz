...
<div class="scroll-smooth overflow-x-auto flex gap-2">
    <div id="toast-notification" class="border-2 border-gray-100 min-w-280 mb-4 w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg cursor-pointer" role="alert">
        <div class="flex items-center">
            <div class="relative inline-block shrink-0">
                <img class="object-cover w-12 h-12 rounded-full" src="https://cdn.pixabay.com/photo/2018/01/15/07/51/woman-3083383__340.jpg" alt="Jese Leos image"/>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex items-baseline justify-between w-full p-3 border-t border-gray-300">
                                ...
                                <label for="message-input" class="hidden">Message</label><textarea placeholder="Message"
                                                                             ...
                                                                             name="message" required id="message-input" rows="5"></textarea>


                                <button>
                                    <span class="hidden">Emoji</span>
                                ...
                                <button type="submit">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500 origin-center ml-2">
