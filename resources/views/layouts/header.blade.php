        ...
        <div class="relative bg-white">
            ...
            @if (is_array(\Illuminate\Support\Facades\Auth::user()->avatarUpload))
                ...
                @endforeach
                                         @endif
                                             "
                                                         src="{{ asset('storage/' . (is_array(\Illuminate\Support\Facades\Auth::user()->avatarUpload) ? \Illuminate\Support\Facades\Auth::user()->avatarUpload[0] : \Illuminate\Support\Facades\Auth::user()->logoUpload)) }}"
                                                         alt="Profile Picture of {{ \Illuminate\Support\Facades\Auth::user()->firstname . \Illuminate\Support\Facades\Auth::user()->lastname }}"/>
                                                @endif
                                            @endif
                                            <div class="ml-3 text-sm font-normal">
                ...
                <nav class="hidden md:flex space-x-10">
                    <x-nav-link kind="primary" href="{{ route('ads.index') }}"
                                class="{{ Route::currentRouteName() === 'ads' || Route::currentRouteName() === 'ads.show' ? 'font-extrabold text-purple-700' : '' }}">
                        Ads
                    </x-nav-link>
                    <x-nav-link kind="primary" href="{{ route('workers.index') }}"
                                class="{{ Route::currentRouteName() === 'workers' || Route::currentRouteName() === 'workers.show' ? 'font-extrabold text-purple-700' : '' }}">
                        Workers
                    </x-nav-link>
                    <x-nav-link kind="primary" href="{{ route('contact-us.index') }}"
                                class="{{ Route::currentRouteName() === 'contact-us' ? 'font-extrabold text-purple-700' : '' }}">
                        Contact
                    </x-nav-link>
                    <x-nav-link kind="primary" href="{{ route('about-us.index') }}"
                                class="{{ Route::currentRouteName() === 'about-us'  ? 'font-extrabold text-purple-700' : '' }}">
                        About us
                    </x-nav-link>
            ...
            <div
                class="nav_open hidden absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        ...
        <div class="relative bg-white">
            <div
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0 gap-4">
                    <x-nav-link kind="primary" id="signin-link" href="{{ route('login') }}"
                                data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                                type="button"
                                class="{{ Route::currentRouteName() === 'login' ? 'font-extrabold text-purple-700' : '' }}">
                        Sign in
                    </x-nav-link>
                    ...
                    <div class="py-6 px-5">
                        <div class="mt-6">
                            ...
                            <p class="mt-6 text-center text-base font-medium text-gray-500">
                                Existing customer?
                                <x-nav-link kind="primary" data-modal-target="authentication-modal"
                                            data-modal-toggle="authentication-modal" type="button"
                                            class="text-indigo-500" href="{{ route('login') }}">Sign in
                                </x-nav-link>
                            </p>
                        </div>
                    </div>
