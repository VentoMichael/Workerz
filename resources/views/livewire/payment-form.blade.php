                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        <label for="card-element" class="block text-sm font-medium leading-6 text-gray-900">Credit or
                            debit card</label>
                        <div wire:model.live="paymentMethods" wire:ignore id="card-element" name="card-element"
                    ...
                    <div class="mt-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                                    ...
                                    <div class="space-y-6 sm:pl-6">
                                        ...
                                        @if($previousSubscription)
                                            <div
                                                ...
                                                <div>
                                                    <span class="font-medium">Price based on prior subscription.</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                        ...
                        <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                            <x-button class="w-full" id="card-button" data-secret="{{ $intent->client_secret }}"
                                ...
                                <svg id="loading-svg" aria-hidden="true"
                                     class="hidden inline w-5 h-5 ml-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
