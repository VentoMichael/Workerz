    ...
    <form wire:submit.prevent="subscribe" class="mt-4 sm:flex sm:max-w-md" method="get">
        ...
        <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <x-button type="submit" kind="primary" class="disabled:opacity-50">
                Subscribe
                <svg wire:loading wire:target="subscribe" aria-hidden="true" class="inline w-5 h-5 ml-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
